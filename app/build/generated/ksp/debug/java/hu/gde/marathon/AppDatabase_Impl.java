...
public final class AppDatabase_Impl extends AppDatabase {
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS `names` (`id` TEXT NOT NULL, `firstName` TEXT NOT NULL, `lastName` TEXT NOT NULL, PRIMARY KEY(`id`))");
        db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, 'e80b575ee302b1a9b2124ed2f01bb8cc')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        _columnsNames.put("id", new TableInfo.Column("id", "TEXT", true, 1, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        final TableInfo _existingNames = TableInfo.read(db, "names");
        if (!_infoNames.equals(_existingNames)) {
          return new RoomOpenHelper.ValidationResult(false, "names(hu.gde.marathon.Name).\n"
                  + " Expected:\n" + _infoNames + "\n"
                  + " Found:\n" + _existingNames);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "e80b575ee302b1a9b2124ed2f01bb8cc", "a74c3400ba7df4390a76c5db86392da9");
  ...
  protected InvalidationTracker createInvalidationTracker() {
    ...
    return new InvalidationTracker(this, _shadowTablesMap, _viewTables, "names");
  }
